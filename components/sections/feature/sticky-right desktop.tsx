...
interface FeatureStickyRightProps {
  title?: string;
...
export default function FeatureStickyRight({
  ...
  description = (
    <>
      <p>A comprehensive collection of components written in modern React, Typescript and Tailwind CSS.</p>
      <p>You&apos;ll find here everything you need to build your next landing page.</p>
    </>
  ),
  visual,
  imageLight = "/img/render2.png",
  imageDark = "/img/render2.png",
  videoSrc,
  className,
}: FeatureStickyRightProps) {
  return (
    <Section
      className={cn(
    ...
    >
      <div className="max-w-container relative z-10 mx-auto flex flex-col-reverse items-center gap-12 md:flex-row md:items-start lg:gap-24">
        <div className="relative z-10 max-w-[320px] md:max-w-[1500px]">
          {visual || (
